    ...
    return (
        <div>
           ...
           <br/>
            ...
            <br/>
                <div class="container">
                <h2 style={{textAlign:'center',fontWeight:500,color:'royalblue'}}>
           Terms and Conditions for all Apps under Production is here</h2>
           <br/>
            <br/>
            <div class="iiu">
            ...
            <br/>
                ...
                <div class="container">
                <h2 style={{textAlign:'center',fontWeight:500,color:'darkorchid'}}>
           Refund and Return Policies are here</h2>
           <br/>
            <br/>
            <div class="iiu">
          ...
          <div class="mkk">
              <div class="container">
              <h2 style={{textAlign:'center',fontWeight:500,color:'green'}}>
          Privacy Policies for the App is here</h2>
           <br/>
            <br/>
            <div class="iiu">
